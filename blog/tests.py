...
class TestView(TestCase): #113. 이런식으로 TestCase를 확장시켜준다.
    ...
    def test_post_detail(self): #137. 위의 테스트 조건과는 다른 것을 한다.
        ...
        self.assertIn(post_001.title, soup.title) #144. post_001의 타이틀이 soup에 있어야 한다는 뜻
        ...
        self.assertIn(post_001.content, post_area.text) #147. post_001의 content가 post_area.text 안에(self.assertIn) 있다는 뜻